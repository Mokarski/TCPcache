...
//       if ( mode2 == 0 ) {// diagnostic mode is off
           if (mode1 == 1 && control1 == 1) result=1; //oil upload in tank - "Zaka4ka" "Mestno"
           if (mode1 == 0 && control1 == 1) result=2; //work at local keyboard - "Rabota" "mestno"
           if (mode1 == 0 && control1 == 0) result=3; //work at wire  mode "Rabota" "Provod"
           if (mode1 == 0 && control2 == 1) result=4; //work at wire  mode "Rabota" "RPDU"           
//          }
          
           if ( mode2 == 1 && control1 == 1 ) result = 5; // diagnostic mode is ON
return result;
}
