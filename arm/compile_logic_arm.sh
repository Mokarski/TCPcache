...
echo "final assembly"
/opt/freescale/usr/local/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/arm-fsl-linux-gnueabi-gcc -o client_logic_arm signalhash.c ringbuffer.c keyboard.c process.c client_logic_arm.o signals_arm.o  speedtest.o network_arm.o hash_arm.o -lpthread -lrt
