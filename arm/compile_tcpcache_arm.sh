...
/opt/freescale/usr/local/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/arm-fsl-linux-gnueabi-gcc -D_REENTERANT -I/usr/include/nptl -L/usr/lib/nptl -pthread  -o  tcpcache tcpcache.o signals_arm.o speedtest.o
